...
Característica: Dar permisos de movilidad a un usuario
    ...
    quiero dar permisos de movilidad a un usuario registrado
    para que el usuario pueda tener acceso a los convenios nacionales e internacionales
    ...
    Escenario: Cambio correcto
        ...
        y selecciono el grupo de movilidad
        y presiono guardar
        y cierro sesión
        y ingreso al login
        ...
        Cuando cliqueo el botón identificarse
        Y puedo ver la página de inicio
        Entonces puedo ver la seccion "Internacionales"